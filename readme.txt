...
* Multiple slideshow configuration options 
* Has Admin Preview
...
1. Install the plugin through Plugins > Add New > Upload or by copying the unzipped package to wp-content/plugins/  named wpsus.
2. Activate the Wp Super Slider plugin through the 'Plugins > Installed Plugins' menu in WordPress.
...
1. Go to Wp Super Slider > Add New and click the 'Add Panels' button.
...
= How can I publish a slider? =
To publish sliders:

Copy the [wpsus id="1"] shortcode in the post or page where you want the slider to appear. You can also insert it in PHP code by using <?php do_shortcode( '[wpsus id="1"]' ); ?>, 
...
= Why After updating facing problem creating slider? =

If some functions are updated to sometimes it causes problem. You may try dactivating/deleting the one installed exporting curent slider. then install and export again.

== Screenshots ==

1. List and admin page.
2. Create new.
3. View in page.
4. Types of sliders you can create.
...
= 1.0.3 =
- Initial update, basic functions and tags for flicker.

= 1.0.4 =
- WordPress version upgrade.

= 1.0.5 =
- Domain updated for translation support.
