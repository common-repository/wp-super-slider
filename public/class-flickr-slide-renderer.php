 ...
 * @since 1.0.0
 */
class WPSS_WPS_Flickr_Slide_Renderer extends WPSS_WPS_Dynamic_Slide_Renderer {
	...
	public function __construct() {
		...
		$this->registered_tags = apply_filters( 'wpsus_flickr_tags', $this->registered_tags );
	}
	...
	protected function query() {
		...
		if ( $api_key !== '' ) {
			$this->flickr_instance = new WPSS_Flickr( $api_key );
		} else {
			return false;
		}
