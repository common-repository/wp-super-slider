<?php
/**
 * Renderer for slides created from posts data.
 * 
 * @since 1.0.0
 */
class WPSS_WPS_Posts_Slide_Renderer extends WPSS_WPS_Dynamic_Slide_Renderer {
	...
	public function __construct() {
		...
		$this->registered_tags = apply_filters( 'wpsus_posts_tags', $this->registered_tags );
	}
	...
	/**
	 * Query the database based on the specified slide settings
	 * using WP_Query.
	 *
	 * @since 1.0.0
	 * 
	...
	protected function query() {
		...
		$query_args = apply_filters( 'wpsus_posts_query_args' , $query_args, $this->slider_id, $this->slide_index );
	...
	/**
	 * Return the link of the post as an HTML anchor element.
	 *
	 * @since 1.0.0
	 * 
	 * @param  string $tag_arg The argument (optional) of the tag.
