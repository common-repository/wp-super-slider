...
class WPSS_WPS_Layer_Renderer {
	...
	public function __construct() {
		$this->default_settings = WPSS_WpSus_Settings::getLayerSettings();
	}
	...
	protected function get_classes() {
		...
		if ( isset( $this->settings['display'] ) ) {
			$classes .= ' wps-' . $this->settings['display'];
		...
		$classes = apply_filters( 'wpsus_layer_classes', $classes, $this->slider_id, $this->slide_index );
