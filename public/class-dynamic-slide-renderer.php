 ...
 * @since 1.0.0
 */
class WPSS_WPS_Dynamic_Slide_Renderer extends WPSS_WPS_Slide_Renderer {
	...
	public function __construct() {
		...
		$this->default_settings = WPSS_WpSus_Settings::getSlideSettings();
	}
	 ...
	 *
	 * Get the tags by matching all the '[wps_' occurances and
	...
	protected function get_slide_tags() {
		...
		preg_match_all( '/\[wps_(.*?)\]/', $this->html_output, $matches, PREG_SET_ORDER );
